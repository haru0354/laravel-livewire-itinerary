<div>
    ...
    <div>
        ...
        <div class="flex flex-wrap justify-center">
            ...
            <div class="relative flex-wrap w-full max-w-[480px] my-6 mx-4 p-6 shadow-lg hover:shadow-2xl transition-shadow rounded-lg border border-gray-300 bg-gray-50">
